...
const login =
  "https://images.pexels.com/photos/16242338/pexels-photo-16242338.jpeg?auto=compress&cs=tinysrgb&w=1200";
...
const Login = () => {
  ...
  const linkBtn = "mt-4 text-naqsh-gold hover:text-naqsh-umber transition text-sm";
  ...
  return (
    <div className="flex min-h-screen bg-naqsh-ivory">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-12">
        {resetStep === 0 ? (
          <form onSubmit={handleLogin} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-naqsh-noir">Welcome Back</h2>
          ...
          <form onSubmit={handleSendOtp} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-naqsh-noir">Reset Password</h2>
            <div className="mb-6">
              <label className="block text-sm font-medium mb-2 text-naqsh-umber">Email</label>
              <input
                type="email"
          ...
          <form onSubmit={handlePasswordReset} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-naqsh-noir">Reset Password</h2>
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2 text-naqsh-umber">OTP</label>
              <input
                type="text"
                value={resetOtp}
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2 text-naqsh-umber">New Password</label>
              <input
                type="password"
                value={newPassword}
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium mb-2 text-naqsh-umber">Confirm Password</label>
              <input
                type="password"
      ...
      <div className="hidden md:block w-1/2 relative overflow-hidden">
        <img src={login} alt="Naqsh" className="h-full w-full object-cover" />
        ...
        <div className="absolute bottom-10 left-10 text-naqsh-ivory">
          ...
          <p className="text-lg opacity-90">Sign in to access your Naqsh account</p>
        </div>
      </div>
    </div>
  );
